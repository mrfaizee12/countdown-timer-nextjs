...
export default function Countdown() {
  ...
  const timerRef = useRef<number | null>(null);  // Updated ref type

  const handleSetDuration = (): void => {  // Fixed typo in function name
  ...
  const handleReset = (): void => {  // Fixed typo in function name
    setIsActive(false);
    setIsPaused(false);
  ...
  useEffect(() => {
    if (isActive && !isPaused) {
      timerRef.current = window.setInterval(() => {  // Use window.setInterval in browser
